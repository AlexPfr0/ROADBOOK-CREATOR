...
class expressions {
    ...
    public $nom_rb              = "Nom du roadbook";
    public $nb_etapes           = "étapes";
    public $nb_pages            = "page";
    
    public $kilometrage         = "Kilométrage";
    ...
    public $export_pdf_btn      = "Télécharger le PDF";
    public $export_pdf          = "Une fois que vous avez terminé, exporter votre travail en PDF.";
    public $DIRECTIONS          = "DIRECTIONS";
    public $RONDS_POINTS        = "RONDS-POINTS";
