// Cette classe permet de construire le roadbook sur UNE SEULE COLONNES. Elle contient les fonctions pour
// 3 cas différents :
...
var ConstruireRoadbook_1Col = function () {
    ...
    this.depuisDonneesBrutes = function () {
        ...
        var epp = 6;  // nombre d'étapes par page
        var nb_col = 1; // nombre de colonne
...
//                var arrivee = this.motCleInit(this.getCookie("_RBC_Langage")).arrivee;
            ...
            // modeCorrection inactif => On génére tout le roadbook, tout le HTML, toutes les données présentes sont écrasées
           ...
           $('#nb_km a').append(dTotale + ' ' + abbrUnite);
            ...
            // Elle est incrémentée de "var epp" à chaque fin de page
            var t = 0;
            var q = 1;
...
evenement.console("Calculs page " + n +" ...", 'alertA');
                ...
                if (modeCorrection === 'inactif') {
                    ...
                    $("#page-" + n).append(elementTable.entete_1Col(n));

//                    $("#page-" + n).append(elementTable.entete_1Col());
...
// Si le mode correction des distances n'est pas activé, on crée une nouvelle ligne HTML.
                    if (modeCorrection === 'inactif') {
                        ...
                        $("#page-" + n)
                                .append(elementTable.nouvelleLigne_1_Colonne(
...
;                           
                            ...
                            elementTable.corrigeDistances_1_Colonne(eNumero, edParcourue, edRestante, edPartielle);
...
//                                $("#page-" + n).append(elementTable.ligneVide(2, 'Page ' + n + ' - Généré avec ROADBOOK CREATOR by Alex', 'https://roadbook.alexp.fr'));
                ...
                // Fin du tableau en cas de Correction = inactif
                if (modeCorrection === 'inactif') {
//                    $("#page-" + n).append(elementTable.ligneVide(2, 'Page ' + n + ' - Généré avec ROADBOOK CREATOR by Alex', 'https://roadbook.alexp.fr'));
                    $("#page-" + n).append('</table>');
                }
...
// on initialise les valeur à rien, soit vide. (sauf pour le n° d'étape)
                        ...
                        $("#page-" + n).append(elementTable.nouvelleLigne_1_Colonne(num_etape,
